...
router.get("/show/:id", auth([1, 2, 11, 13]), paymentPostController.show);

router.get("/", auth([1, 2, 11, 13]), paymentPostController.showAll);

router.get('/show-total', auth([1, 2, 6, 11, 13]), paymentPostController.showTotal)
