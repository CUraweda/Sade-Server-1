...
class ParentService {
    ...
    createParent = async (reqBody) => {
        try {
            ...
            const data = await this.parentDao.create(reqBody);
    ...
    importFromExcel = async (req) => {
        try {
            ...
            const data = await this.parentDao.bulkCreate(jsonData);
    ...
    showParent = async (id) => {
        ...
        const dt = await this.parentDao.findById(id);
    ...
    showParentByStudentId = async (id) => {
        ...
        const dt = await this.parentDao.findByStudentId(id);
    ...
    async showPage(page, limit, search, offset) {
        ...
        return responseHandler.returnSuccess(httpStatus.OK, 'Parent successfully retrieved.', {
            result,
            page,
            limit,
            totalRows,
    ...
    deleteParent = async (id) => {
        ...
        const dt = await this.parentDao.deleteByWhere({ id });
