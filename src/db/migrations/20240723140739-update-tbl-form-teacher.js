...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.renameColumn('tbl_form_teacher', 'status', 'is_active');

    // Change the data type of the renamed column to BOOLEAN
    await queryInterface.changeColumn('tbl_form_teacher', 'is_active', {
  ...
  async down(queryInterface, Sequelize) {
    ...
    await queryInterface.renameColumn('tbl_form_teacher', 'is_active', 'status');
  }
};
