...
router.get('/show/:id', auth([1, 2, 3, 4, 5, 6, 7, 8]), forCountryDetailController.show);
...
router.get(
    '/show-by-country-id/:id',
    auth([1, 2, 3, 4, 5, 6, 7, 8]),
    forCountryDetailController.showByCountryId,
);

router.get('/', auth([1, 2, 3, 4, 5, 6, 7, 8]), forCountryDetailController.showAll);

router.delete('/delete/:id', auth([1, 2, 3, 4, 5, 6, 7, 8]), forCountryDetailController.delete);
