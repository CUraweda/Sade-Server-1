...
router.get('/show/:id', auth([1, 2, 3, 4, 5, 6, 7, 8]), forCountryController.show);

router.get('/show-by-user/:id', auth([1, 2, 3, 4, 5, 6, 7, 8]), forCountryController.showByUserId);

router.get('/', auth([1, 2, 3, 4, 5, 6, 7, 8]), forCountryController.showAll);

router.delete('/delete/:id', auth([1, 2, 3, 4, 5, 6, 7, 8]), forCountryController.delete);
